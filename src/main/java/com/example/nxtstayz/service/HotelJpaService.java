...
public class HotelJpaService implements HotelRepository {
    ...
    public HotelJpaRepository getHotelJpaRepository() {
        return hotelJpaRepository;
    }

    public void setHotelJpaRepository(HotelJpaRepository hotelJpaRepository) {
        this.hotelJpaRepository = hotelJpaRepository;
    }

    public RoomJpaRepository getRoomJpaRepository() {
